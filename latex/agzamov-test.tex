...
\paragraph{License.} Code: MIT. Paper and specification: CC~BY~4.0. The benchmark protocol is open; any memory system, model provider, or orchestration framework may be evaluated.
